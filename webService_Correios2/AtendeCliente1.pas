...
type
  ...
  Exception            = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblCplx] }
  SQLException         = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblCplx] }
  Exception2           = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Flt][GblElm] }
  SQLException2        = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Flt][GblElm] }
  ...
  return               = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Alias] }
  return2              = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Alias] }
  return3              = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Alias] }
  return4              = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Alias] }
  return5              = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Alias] }
  ...
  return6              = class;                 { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[Alias] }
  ...
  // ************************************************************************ //
  Exception2 = class(ERemotableException)
  private
    Fmessage_: string;
    Fmessage__Specified: boolean;
    procedure Setmessage_(Index: Integer; const Astring: string);
  ...
  // ************************************************************************ //
  SQLException2 = class(ERemotableException)
  private
    FerrorCode: Integer;
    FerrorCode_Specified: boolean;
    FsQLState: string;
  ...
  // Namespace : http://cliente.bean.master.sigep.bsb.correios.com.br/
  // ************************************************************************ //
  return2 = class(mensagemRetornoPIMaster)
  private
  published
  end;
  ...
  // Namespace : http://cliente.bean.master.sigep.bsb.correios.com.br/
  // ************************************************************************ //
  return3 = class(embalagemLRSMaster)
  private
  published
  end;
  ...
  Array_Of_servicoERP = array of servicoERP;    { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblUbnd] }
  ...
  private
    ...
    procedure Setnumero(Index: Integer; const Astring: string);
    function  numero_Specified(Index: Integer): boolean;
    procedure Setservicos(Index: Integer; const AArray_Of_servicoERP: Array_Of_servicoERP);
  ...
  published
    ...
    property horajAtualizacao:                 Integer                      Index (IS_OPTN or IS_UNQL) read FhorajAtualizacao write SethorajAtualizacao stored horajAtualizacao_Specified;
    property numero:                           string                       Index (IS_OPTN or IS_UNQL) read Fnumero write Setnumero stored numero_Specified;
    property servicos:                         Array_Of_servicoERP          Index (IS_OPTN or IS_UNBD or IS_NLBL or IS_UNQL) read Fservicos write Setservicos stored servicos_Specified;
  ...
  Array_Of_retorno = array of retorno;          { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblUbnd] }
  Array_Of_mensagemRetornoPIMaster = array of mensagemRetornoPIMaster;   { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblUbnd] }
  Array_Of_int = array of Integer;              { "http://www.w3.org/2001/XMLSchema"[GblUbnd] }
  Array_Of_embalagemLRSMaster = array of embalagemLRSMaster;   { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblUbnd] }
  Array_Of_motivoPIMaster = array of motivoPIMaster;   { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblUbnd] }
  Array_Of_assuntoPIMaster = array of assuntoPIMaster;   { "http://cliente.bean.master.sigep.bsb.correios.com.br/"[GblUbnd] }
  ...
  ['{06395354-FEDE-FDC9-368D-51C37A49D0E0}']
    ...
    function  registrarPedidosInformacao(const pedidosInformacao: Array_Of_pedidoInformacaoRegistro; const usuario: string; const senha: string): Array_Of_retorno; stdcall;
    ...
    function  obterMensagemRetornoPI: Array_Of_mensagemRetornoPIMaster; stdcall;
    function  consultarPedidosInformacao(const pedidosInformacao: Array_Of_pedidoInformacaoConsulta; const usuario: string; const senha: string): Array_Of_retorno; stdcall;
    function  buscaPagamentoEntrega(const usuario: string; const senha: string): string; stdcall;
    function  geraDigitoVerificadorEtiquetas(const etiquetas: Array_Of_string; const usuario: string; const senha: string): Array_Of_int; stdcall;
    ...
    function  obterEmbalagemLRS: Array_Of_embalagemLRSMaster; stdcall;
    ...
    function  buscaServicos(const idContrato: string; const idCartaoPostagem: string; const usuario: string; const senha: string): Array_Of_servicoERP; stdcall;
    ...
    function  obterMotivosPI: Array_Of_motivoPIMaster; stdcall;
    ...
    function  obterAssuntosPI: Array_Of_assuntoPIMaster; stdcall;
...
begin
  ...
  SysUtils.FreeAndNil(Fconta);
  SysUtils.FreeAndNil(Fdestinatario);
  SysUtils.FreeAndNil(Fpostagem);
  SysUtils.FreeAndNil(Fremetente);
  inherited Destroy;
end;
...
begin
  SysUtils.FreeAndNil(FdataAtualizacao);
  inherited Destroy;
end;
...
begin
  SysUtils.FreeAndNil(FdataFinal);
  SysUtils.FreeAndNil(FdataInicial);
  inherited Destroy;
end;
...
begin
  SysUtils.FreeAndNil(Fchancela);
  SysUtils.FreeAndNil(FservicoERP);
  inherited Destroy;
end;
...
begin
  SysUtils.FreeAndNil(FdataAtualizacaoCliente);
  SysUtils.FreeAndNil(FdataCancelamentoEtiqueta);
  SysUtils.FreeAndNil(FdataInclusao);
  SysUtils.FreeAndNil(FobjetoPostalPK);
  SysUtils.FreeAndNil(FpreListaPostagem);
  inherited Destroy;
end;
...
begin
  SysUtils.FreeAndNil(Fobjeto_postal);
  inherited Destroy;
end;
...
begin
  for I := 0 to System.Length(FcartoesPostagem)-1 do
    SysUtils.FreeAndNil(FcartoesPostagem[I]);
  System.SetLength(FcartoesPostagem, 0);
  SysUtils.FreeAndNil(Fcliente);
  SysUtils.FreeAndNil(FcontratoPK);
  SysUtils.FreeAndNil(FdataAtualizacao);
  SysUtils.FreeAndNil(FdataVigenciaFim);
  SysUtils.FreeAndNil(FdataVigenciaInicio);
  SysUtils.FreeAndNil(FdiretoriaRegional);
  inherited Destroy;
end;
...
begin
  for I := 0 to System.Length(FunidadesPostagem)-1 do
    SysUtils.FreeAndNil(FunidadesPostagem[I]);
...
procedure cartaoPostagemERP.Setservicos(Index: Integer; const AArray_Of_servicoERP: Array_Of_servicoERP);
begin
  Fservicos := AArray_Of_servicoERP;
...
begin
  for I := 0 to System.Length(FservicosAdicionais)-1 do
    SysUtils.FreeAndNil(FservicosAdicionais[I]);
  System.SetLength(FservicosAdicionais, 0);
  SysUtils.FreeAndNil(FdataAtualizacao);
  SysUtils.FreeAndNil(FservicoSigep);
...
begin
  for I := 0 to System.Length(FservicosSigep)-1 do
    SysUtils.FreeAndNil(FservicosSigep[I]);
...
begin
  for I := 0 to System.Length(Fparametros)-1 do
    SysUtils.FreeAndNil(Fparametros[I]);
  System.SetLength(Fparametros, 0);
  SysUtils.FreeAndNil(FdataAtualizacao);
  SysUtils.FreeAndNil(FdataInclusao);
  SysUtils.FreeAndNil(FdataSenha);
  SysUtils.FreeAndNil(FgerenteMaster);
  inherited Destroy;
end;
...
begin
  for I := 0 to System.Length(FobjetosPostais)-1 do
    SysUtils.FreeAndNil(FobjetosPostais[I]);
  System.SetLength(FobjetosPostais, 0);
  SysUtils.FreeAndNil(FcartaoPostagem);
  SysUtils.FreeAndNil(FdataAtualizacaoCliente);
  SysUtils.FreeAndNil(FdataAtualizacaoSara);
  SysUtils.FreeAndNil(FdataFechamento);
  SysUtils.FreeAndNil(FdataPostagem);
  SysUtils.FreeAndNil(FdataPostagemSara);
  inherited Destroy;
end;
...
begin
  for I := 0 to System.Length(Fproduto)-1 do
    SysUtils.FreeAndNil(Fproduto[I]);
...
begin
  for I := 0 to System.Length(Fobj_col)-1 do
    SysUtils.FreeAndNil(Fobj_col[I]);
...
initialization
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(postagem), 'local_', 'local');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SQLException), 'message_', 'message');
  RemClassRegistry.RegisterXSClass(Exception2, 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Exception2', 'Exception');
  RemClassRegistry.RegisterExternalPropName(TypeInfo(Exception2), 'message_', 'message');
  ...
  RemClassRegistry.RegisterExternalPropName(TypeInfo(SQLException2), 'message_', 'message');
  ...
  RemClassRegistry.RegisterXSClass(return, 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'return');
  RemClassRegistry.RegisterXSClass(return2, 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'return2', 'return');
  RemClassRegistry.RegisterXSClass(return3, 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'return3', 'return');
  RemClassRegistry.RegisterXSClass(return4, 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'return4', 'return');
  RemClassRegistry.RegisterXSClass(return5, 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'return5', 'return');
  ...
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_pedidoInformacaoRegistro), [xoInlineArrays]);
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_servicoERP), 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Array_Of_servicoERP');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_servicoERP), [xoInlineArrays]);
  ...
  RemClassRegistry.RegisterXSClass(return6, 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'return6', 'return');
  ...
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_objetoPostal), [xoInlineArrays]);
  ...
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_pedidoInformacaoConsulta), [xoInlineArrays]);
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_retorno), 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Array_Of_retorno');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_retorno), [xoInlineArrays]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_mensagemRetornoPIMaster), 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Array_Of_mensagemRetornoPIMaster');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_mensagemRetornoPIMaster), [xoInlineArrays]);
  ...
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_embalagemLRSMaster), 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Array_Of_embalagemLRSMaster');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_embalagemLRSMaster), [xoInlineArrays]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_motivoPIMaster), 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Array_Of_motivoPIMaster');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_motivoPIMaster), [xoInlineArrays]);
  RemClassRegistry.RegisterXSInfo(TypeInfo(Array_Of_assuntoPIMaster), 'http://cliente.bean.master.sigep.bsb.correios.com.br/', 'Array_Of_assuntoPIMaster');
  RemClassRegistry.RegisterSerializeOptions(TypeInfo(Array_Of_assuntoPIMaster), [xoInlineArrays]);
